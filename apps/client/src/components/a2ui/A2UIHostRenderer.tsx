...
const NAVIGABLE_PANELS = new Set([
  "brain", "persona", "memory", "knowledge", "schedules", "webhooks", "skills",
  "tools", "connections", "integrations", "integration-catalog", "conversations",
  "activity", "emotion-history", "registry",
]);
...
export function A2UIHostRenderer({ surfaceId, surface }: { surfaceId: string; surface: A2UISurface }) {
  ...
  return (
    <A2UIActionProvider dispatch={dispatch}>
