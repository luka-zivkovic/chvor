const CREDENTIAL_ASSIGNMENT_RE =
  /\b(password|passcode|api[_\-\s]?key|token|secret|authorization)\s*(?:is|as|=|:)\s*(?:Bearer\s+)?\S+/i;
...
const SENSITIVE_PATTERNS: RegExp[] = [
  ...
  CREDENTIAL_ASSIGNMENT_RE, // credential-like assignments/prose
