...
```json
{ "surfaceUpdate": { "surfaceId": "my-dashboard", "components": [
  { "id": "root", "component": { "Column": { "children": { "explicitList": ["title", "chart1"] }, "gap": 16 } } },
  { "id": "title", "component": { "Text": { "text": { "literalString": "System Status" }, "usageHint": "h1" } } },
  { "id": "chart1", "component": { "Chart": { "chartType": "bar", "data": { "binding": "metrics" }, "title": "CPU Usage" } } }
] } }
```
...
```json
{ "dataModelUpdate": { "surfaceId": "my-dashboard", "bindings": { "metrics": [{ "label": "Core 1", "value": 72 }, { "label": "Core 2", "value": 45 }] } } }
```
